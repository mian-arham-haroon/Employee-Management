...
def connect_database():
    ...
    try:
        ...
        messagebox.showerror('Error','Something want wrong,Please open mysql app defore running again')
        return
...
def update(id,new_name,new_phone,new_role,new_gender,naw_salary):
    mycursor.execute('UPDATE data SET name=%s,phone=%s,role=%s,gender=%s,salary=%s WHERE id=%s',(new_name,new_phone,new_role,new_gender,naw_salary,id))
    conn.commit()
